...
namespace Settings::Alerts::Steps
{
enum Id {
    ID_OFF = 0,
    ID_STEPS_500,
...
static constexpr uint16_t kStepsList[Settings::Alerts::Steps::ID_COUNT] = { 0,500,1000,2000,5000,10000 };
static constexpr uint16_t kDistanceList[Settings::Alerts::Distance::ID_COUNT] = { 0,1,2,3,4,5,10 };
static constexpr uint16_t kTimeList[Settings::Alerts::Time::ID_COUNT] = { 0,10,20,30,60 };
