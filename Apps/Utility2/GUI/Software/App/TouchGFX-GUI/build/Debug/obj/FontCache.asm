; Listing generated by Microsoft (R) Optimizing Compiler Version 19.42.34436.0 
	...
	TITLE	C:\DT\Solutions\Una\una-watch\Apps\Utility2\GUI\Software\App\TouchGFX-GUI\build\Debug\obj\FontCache.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__90451095_FontCache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1PI@JIAPEILJ@?$AAC?$AA?3?$AA?2?$AAD?$AAT?$AA?2?$AAS?$AAo?$AAl?$AAu?$AAt?$AAi?$AAo?$AAn?$AAs@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1PI@JIAPEILJ@?$AAC?$AA?3?$AA?2?$AAD?$AAT?$AA?2?$AAS?$AAo?$AAl?$AAu?$AAt?$AAi?$AAo?$AAn?$AAs@
CONST	SEGMENT
??_C@_1PI@JIAPEILJ@?$AAC?$AA?3?$AA?2?$AAD?$AAT?$AA?2?$AAS?$AAo?$AAl?$AAu?$AAt?$AAi?$AAo?$AAn?$AAs@ DB 'C'
	...
	DB	'y', 00H, 'p', 00H, 'e', 00H, 'd', 00H, 'T', 00H, 'e', 00H, 'x'
	DB	00H, 't', 00H, '.', 00H, 'h', 00H, 'p', 00H, 'p', 00H, 00H, 00H ; `string'
CONST	ENDS
...
; _this$ = ecx
; File C:\DT\Solutions\Una\una-watch\Apps\Utility2\GUI\Software\App\TouchGFX-GUI\generated\fonts\include\fonts\CachedFont.hpp
; Line 82
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __B0933683_CachedFont@hpp
...
; _this$ = ecx
; File C:\DT\Solutions\Una\una-watch\Apps\Utility2\GUI\Software\App\TouchGFX-GUI\generated\fonts\src\FontCache.cpp
; Line 418
	push	ebp
	mov	ebp, esp
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __90451095_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
	npad	1
; Line 419
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+136], 0
	je	SHORT $LN2@readData
; Line 421
	mov	eax, DWORD PTR _this$[ebp]
...
; Line 277
	mov	eax, DWORD PTR _this$[ebp]
	movzx	ecx, WORD PTR [eax+214]
	mov	edx, DWORD PTR _this$[ebp]
	movzx	eax, WORD PTR [edx+212]
	cmp	ecx, eax
	jge	SHORT $LN3@copyGlyph
	mov	eax, DWORD PTR _this$[ebp]
	movzx	ecx, WORD PTR [eax+222]
...
$LN3@getTextDir:
	mov	esi, esp
	push	144					; 00000090H
	push	OFFSET ??_C@_1PI@JIAPEILJ@?$AAC?$AA?3?$AA?2?$AAD?$AAT?$AA?2?$AAS?$AAo?$AAl?$AAu?$AAt?$AAi?$AAo?$AAn?$AAs@
