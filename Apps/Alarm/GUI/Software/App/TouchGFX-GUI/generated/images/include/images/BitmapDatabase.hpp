...
const uint16_t BITMAP_ALARMBIG_ID = 0;
...
const uint16_t BITMAP_MENUASSETS_CIRCLECROSS_ID = 13;
const uint16_t BITMAP_MENUASSETS_CIRCLEPLUS_ID = 14;
const uint16_t BITMAP_MENUASSETS_CIRCLETICK_ID = 15;
const uint16_t BITMAP_MENUASSETS_TICK_ID = 16;
const uint16_t BITMAP_TOGGLE_DEF_ID = 17;
const uint16_t BITMAP_TOGGLE_HANDLE_ID = 18;
const uint16_t BITMAP_TOGGLE_OFF_ID = 19;
const uint16_t BITMAP_TOGGLE_ON_ID = 20;
